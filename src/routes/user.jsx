  ...
  return (
    <>
      ...
      <div className="container">
        <h1 className="userProfile-heading">Nerd Profile</h1>
        <div className="user-container">
          <div className="user-photo">
            <img
              ...
              alt="user pic"
            />
            <h2 className='user-heading'>Frontend Dev</h2>
            <button className="btn profile-btn">Follow me</button>
            <button className="btn profile-btn">Buzz me</button>
          </div>
